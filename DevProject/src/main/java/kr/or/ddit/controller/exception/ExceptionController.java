...
public class ExceptionController {
	 ...
	 * 		이런점을 고려하여 최대한 사용자가 직접 예외를 처리하여 사용자가 정의한 에러 페이지를 표시하게 해야한다.
	 * 	
	 * 
	 * 1-1) 예외 종류
	 * 		- 스프링 프레임워크 예외
	 ...
	 * 		- D. 존재 하지 않은 게시물 조회할 때, 사용자가 정의한 예외 발생 
	 ...
	 *  
	 *  6. 예외 처리 어노테이션 
	 *  - @ExceptionHandler와 @ControllerAdvice 를 이용하여 처리한다 
	 *  
	 *   	예외 처리 방법 
	 *   	- @ControllerAdvice 어노테이션은 스프링 컨트롤러에서 발생하는 예외를 처리하는 핸들러 클래스임을 명시한다 
	 *   	- @ExceptionHandler 어노테이션은 괄호안에 설정한 예외타입을 해당 메서드가 처리한다는 것을 의미한다
	 *   
	 *   예외 처리 핸들러 생성 
